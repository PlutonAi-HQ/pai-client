...
const HyperLink = forwardRef<HTMLAnchorElement, ComponentPropsWithoutRef<"a">>(
  ({ className, href = "", ...props }, ref) => (
    <Link
      ...
      href={href}
      className={cn(
        "font-sans text-a font-bold leading-none underline",
        className,
      )}
      {...props}
    />
...
const Strong = forwardRef<HTMLSpanElement, ComponentPropsWithoutRef<"strong">>(
  ({ className, ...props }, ref) => (
    <strong
      ref={ref}
...
const Emphasis = forwardRef<HTMLElement, ComponentPropsWithoutRef<"em">>(
  ({ className, ...props }, ref) => (
    <em
      ref={ref}
      className={cn(
        "font-serif text-em font-bold italic leading-none",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <blockquote
    ref={ref}
    className={cn(
      "font-serif text-blockquote font-bold italic leading-none",
      className,
    )}
    {...props}
  />
...
const Pre = forwardRef<HTMLPreElement, ComponentPropsWithoutRef<"pre">>(
  ({ className, ...props }, ref) => (
    <pre
      ref={ref}
...
const Code = forwardRef<HTMLModElement, ComponentPropsWithoutRef<"code">>(
  ({ className, ...props }, ref) => (
    <code
      ref={ref}
...
const Sub = forwardRef<HTMLElement, ComponentPropsWithoutRef<"sub">>(
  ({ className, ...props }, ref) => (
    <sub
      ref={ref}
...
const Sup = forwardRef<HTMLModElement, ComponentPropsWithoutRef<"code">>(
  ({ className, ...props }, ref) => (
    <sup
      ref={ref}
